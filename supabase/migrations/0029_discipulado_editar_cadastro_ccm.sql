-- Discipulado pode atualizar cadastro base do membro (CCM) na própria congregação.
-- A atualização é feita por RPC com validações e escopo por congregação ativa.
