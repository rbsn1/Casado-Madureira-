-- Corrige origem de cadastros criados pelo fluxo do Discipulado.
-- Problema: função create_ccm_member_from_discipleship não definia cadastro_origem
-- e o default da coluna (ccm) acabava classificando incorretamente.
