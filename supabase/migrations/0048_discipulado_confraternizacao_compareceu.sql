...
create index if not exists ccm_discipleship_cases_confraternizacao_compareceu_idx
  on public.ccm_discipleship_cases (congregation_id, confraternizacao_id, confraternizacao_compareceu);
